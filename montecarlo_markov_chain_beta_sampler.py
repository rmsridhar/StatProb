# for theory E:\datascience\statistics\basics of statistics\markov chain\montecarlo markov chain method.docx
import random
...
def plot_beta(a, b):
    ...
    pl.hist(beta_mcmc(10000,a,b),normed=True,bins =100, histtype='step',label="Simulated_MCMC: a="+str(a)+", b="+str(b))
    pl.legend()
    pl.show()
